    ...
    <div class="row g-4 mt-4">
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">📈 Mutual Funds (SIP)</h5>
                    <p class="card-text">Start with as low as ₹500/month. Best for long-term wealth creation with
                        moderate risk.</p>
                    <span class="badge" style="background: var(--brand-secondary); color: var(--brand-dark)">Risk: Medium</span>
                </div>
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">🏦 Fixed Deposit</h5>
                    <p class="card-text">Safe and stable returns (6–7% annually). Ideal for emergency fund parking.</p>
                    <span class="badge" style="background: var(--brand-accent); color: white">Risk: Low</span>
                </div>
                <div class="card-footer bg-white border-0">
                    <button class="btn btn-outline-primary w-100">View Details</button>
                </div>
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">📊 Stock Market</h5>
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">🥇 Gold Investment</h5>
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">💻 Cryptocurrency</h5>
        ...
        <div class="col-md-4">
            <div class="card glass shadow-sm border-0 h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold" style="color: var(--brand-primary)">👴 Retirement Fund (NPS)</h5>
                    <p class="card-text">Secure your future with pension-based returns. Good for tax-saving & stability.
                    </p>
                    <span class="badge" style="background: var(--brand-secondary); color: var(--brand-dark)">Risk: Low–Medium</span>
                </div>
                <div class="card-footer bg-white border-0">
                    <button class="btn btn-outline-primary w-100">View Details</button>
                </div>
